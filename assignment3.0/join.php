...
<p><a href="q02.php">Query 2</a> - Display the distinct days of the week and times (sorted by times) during which Robert Snapp (where clause should not contain his netid but his full name) teaches classes. (3)</p>
...
<p><a href="q05.php">Query 5</a> - Display First Name, Last Name and total number of students taught by each professor (with the field name aliased as 'total'). NOTE: think why some professors have SO many students when you run your query. (14)</p>
